...
- faces-detect.js：opencv.js を用いた顔検出、赤枠の表示など
...
特徴分類器ファイル``haarcascade_frontalface_default.xml``は opencv のリポジトリから落とせます。  
[opencv/data/haarcascades at master · kipr/opencv · GitHub](https://github.com/kipr/opencv/tree/master/data/haarcascades)
