...
この「別のプログラム」が何なのかを取得したいのです。一応、先行研究はありまして、C# や C++ で実現している[先人方](http://hudson.doorblog.jp/archives/41656640.html){:target="_blank"}がいらっしゃいます。でも、どうせなら WinAPI の勉強がてら自分で実装したい、あわよくば GUI も付けて使いやすくしたい、というのが自分なりの欲望です。
