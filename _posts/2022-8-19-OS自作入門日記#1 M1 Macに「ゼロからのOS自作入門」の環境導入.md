...
去年買った「[ゼロからのOS自作入門](https://amzn.to/3Ay4S82){:target="_blank"}」という本（通称「みかん本」）、ある程度進めてからしばらく放置してしまっていたのですが、最近OSの卒業研究でのxv6やLinuxカーネルのコードリーディングを通して、理解を深めるために再びみかん本の写経をやりたいという欲が出てきました。  
