...
最近、主にHTMLやJavaScriptを扱うプロジェクトでVS Codeを使うようになり、便利な拡張機能も多数手に入るようになりました。何よりWindowsでもMacでも同等のUIと機能が利用可能という長所があり、両刀使いの自分にはぴったりですし、VS CodeならGitHub Copilotも利用可能です。  
