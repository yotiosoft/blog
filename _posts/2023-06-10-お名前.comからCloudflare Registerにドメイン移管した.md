...
さらに、今年に入ってから「サービス維持調整費」と題した事実上の値上げが行われています。昨今の情勢や円安のこともあり、国内外のレジストラが軒並み値上げしているので、値上げ自体は理解しますが…
...
お名前.com も含め、ほとんどのドメインレジストラは Verisign の登録手数料に自社の手数料を上乗せして提供しているので、大元が値上げすれば他のサービスもその値上げに追従することになります（サービス維持調整費が設定された理由もこれによるものでしょう）。
